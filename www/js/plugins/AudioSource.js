...
(function () {
  ...
  Game_Character.prototype.processMoveCommand = function (command) {
    var adjust =
      typeof $gameSystem._adjustRouteSe === "boolean"
        ? $gameSystem._adjustRouteSe
        : !PluginManager.registerCommand;
    if (adjust && command.code === Game_Character.ROUTE_PLAY_SE)
  ...
  Sprite_Animation.prototype.processTimingData = function (timing) {
    ...
    if (!this._duplicated && timing.se) {
      var adjust =
        typeof $gameSystem._adjustAnimationSe === "boolean"
          ? $gameSystem._adjustAnimationSe
          : !PluginManager.registerCommand;
      playAdjustSe(
        timing.se,
        adjust && this._target && this._target._character
      );
    }
  };
    ...
    if (command.toLowerCase() === "audiosource") {
      ...
      switch (args[0].toLowerCase()) {
        ...
        case "bgs":
          ...
          break;
        case "se":
          $gameSystem._adjustRouteSe = $gameSystem._adjustAnimationSe =
