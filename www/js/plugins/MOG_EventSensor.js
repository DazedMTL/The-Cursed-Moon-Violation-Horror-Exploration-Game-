...
Moghunter.sensor_range_key = String(
  Moghunter.parameters["Self Switch Key"] || "D"
);
...
// * Init Members
//==============================
var _alias_mog_evensensor_cbase_initMembers =
...
// * Initialize
//==============================
var _alias_mog_evensensor_schar_initialize =
...
Sprite_Character.prototype.initialize = function (character) {
  ...
  if (this._character && this._character._eventId) {
    this._character.check_event_sensor();
  }
};
...
Scene_Map.prototype.terminate = function () {
  ...
  $gameMap.events().forEach(function (event) {
    if (event._sensor_range[0]) {
      $gameSelfSwitches.setValue(event.sensor_key(), false);
    }
  }, this);
};
